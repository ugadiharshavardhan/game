...
export const VILLAGE: VillageLayout = {
  ...
  villagers: [
    ...
    { id: 'mithai-seller', task: 'arranging modak on the trays', pose: 'stand', activity: 'Arrange', x: -7.35, z: -30.3, y: 0, rot: EAST, outfit: 4, scale: 1.08, noCollider: true, name: 'Ganpat-kaka', lines: ['Ukadiche modak, fresh from the steamer! Take them to Bappa — they\'re his favourite.', 'The puja wants five modaks. There are six on the tray, so one is for you.'] },
    ...
    { id: 'well-talk-c', task: 'talking by the well, a brass pot on her hip', kind: 'woman', pose: 'stand', activity: 'Talk', x: -15.6, z: 9.6, y: 0, rot: -2.25, outfit: 2, scale: 0.97, name: 'Sunanda-tai', lines: ['Bring flowers before the moon comes, child. Bappa likes them fresh, and the marigolds go limp in the dark.', 'I fill this pot three times a day. Tonight I am filling it for the puja.'] },
    { id: 'lamp-lighter', task: 'lighting the diyas on the deepastambha', kind: 'pujari', pose: 'light-lamp', x: -4.05, z: -40.55, y: 0, rot: -2.3, outfit: 0, scale: 1.0, name: 'Pujari-kaka', lines: ['The puja needs flowers, durva, a coconut, bananas, rice, diyas and modaks. Bring them to the mandapa.', 'Stand before Bappa and pray — it will steady you after the moonlight.'] },
    // The women of the village: the doorsteps are swept and rangoli drawn before the puja, garlands
    // strung on the verandas. Coordinates are worked out from each house's own front (see houseDims).
    { id: 'sweeper-patil', task: 'sweeping the yard before the Patils’ door', kind: 'woman', pose: 'stand', activity: 'Sweep', x: -17.1, z: 25.1, y: 0, rot: NORTH, outfit: 0, scale: 0.97, name: 'Kaveri-tai', lines: ['Sweep, sweep — the house must be clean before Bappa comes. Mind the moon, though: the lamp by our door is yours if you need it.', 'Marigolds are at the garden past the Shindes’ house. Take a few for me.'] },
    { id: 'rangoli-mane', task: 'drawing rangoli at the Manes’ door', kind: 'woman', pose: 'kneel', activity: 'Rangoli', x: -28.4, z: -8.2, y: 0, rot: SOUTH, outfit: 3, scale: 0.96, name: 'Meenakshi', lines: ['Careful, the rangoli is wet! Every line I draw is for Ganpati Bappa.', 'The rice for the akshata? The kirana on the west lane keeps it on the counter.'] },
    { id: 'stringer-deshmukh', task: 'threading marigolds on the Deshmukhs’ veranda', kind: 'woman', pose: 'sit-edge', activity: 'Stringing', x: -19.4, z: 20, y: 0.45, rot: SOUTH, outfit: 1, scale: 0.97, name: 'Lakshmi-bai', lines: ['A garland takes two hundred flowers. Two hundred! And Bappa wants a new one every morning.', 'Aajoba says he can hear the moon coming. I think he is only sleepy.'] },
    { id: 'wiper-jadhav', task: 'wiping the Jadhavs’ veranda floor', kind: 'woman', pose: 'kneel', activity: 'Wipe', x: 27.9, z: 18, y: 0.45, rot: SOUTH, outfit: 4, scale: 0.96, noCollider: true },
    { id: 'sweeper-gokhale', task: 'sweeping in front of the Gokhales’ house', kind: 'woman', pose: 'stand', activity: 'Sweep', x: -6.1, z: -21, y: 0, rot: EAST, outfit: 5, scale: 0.98, name: 'Parvati-tai', lines: ['The temple is just up the lane. Take what you have and offer it before the clouds part.'] },
    { id: 'stringer-naik', task: 'threading marigolds on the Naiks’ veranda', kind: 'woman', pose: 'sit-edge', activity: 'Stringing', x: 24.6, z: -23, y: 0.45, rot: NORTH, outfit: 2, scale: 0.97, noCollider: true },
    { id: 'rangoli-lady', task: 'helping with the rangoli on the festival ground', kind: 'woman', pose: 'kneel', activity: 'Rangoli', x: 2.4, z: 6.4, y: 0, rot: NORTH, outfit: 0, scale: 0.96 },
    // The priest, at the altar: the aarti lamp in one hand and the bell in the other.
    { id: 'temple-pujari', task: 'waving the aarti before Bappa', kind: 'pujari', pose: 'stand', activity: 'Aarti', x: 2.6, z: -50.6, y: 0.9, rot: NORTH, outfit: 0, scale: 1.0, name: 'Guruji', lines: ['Ganpati Bappa Morya! Set your offerings down before him and the puja begins.', 'Bappa is patient. The moon, less so.'] },
  ],
